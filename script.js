...
InfiniteRunner.draw = function(){
  ...
  this.fillText('Record: '+this.jumpCountRecord, this.width - (100 + (this.aceleration * 4)), 33 - (this.aceleration * 4));
  this.fillStyle = this.scoreColor;
  this.font = (12 + (this.aceleration * 3))+'pt Arial';
  this.fillText('Jumps: '+this.jumpCount, this.width - (100 + (this.aceleration * 4)), 53);
